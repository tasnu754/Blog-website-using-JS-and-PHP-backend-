...
$query = "SELECT id, title, category_id 
           FROM posts WHERE author_id = $current_user_id  ORDER BY id DESC";
...
<section class="dashboard">
  ...
  <div class="container dashboard_container">
    ...
    <main>
        ...
        <table>
          ...
          <tbody>
            <?php while ($post = mysqli_fetch_assoc($posts)) : ?>
              ...
              <!-- get category title from category table using category id -->
              <?php
      ...
      <?php else : ?>
        <div class="alert__messsage error"><?= "No post uploaded yet" ?></div>
      <?php endif ?>
    </main>
